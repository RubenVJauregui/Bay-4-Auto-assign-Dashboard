    ...
    <div className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex flex-col gap-0.5">
            ...
            <p className="text-xs text-[#71717a] tracking-wide">
              DOCK50–DOCK72 &nbsp;|&nbsp; June 6, 2026 &nbsp;|&nbsp; ~11:35 PM PDT
            </p>
          </div>
          {/* Facility badge */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-1">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa]">
                  TASK-5285558 · DOCK53 · LOAD · ~1d 8h · DN-3198181
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  TASK-5285913 · DOCK53 · LOAD · ~1d 2h · DN-3203261 +1
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  TASK-5285860 · DOCK54 · LOAD · ~1d 3h · 4 DNs
                </span>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#ef4444]">
                  ⚠ DOCK54 double-booked with Lorenzo (TASK-5285010 ~2d 3h)
                </span>
                <span className="text-xs text-[#ef4444]">
        ...
        <section>
          <div className="bg-[#141419] border border-[#1e1e2a] rounded-xl p-5 flex flex-col gap-2">
            ...
            <ul className="text-xs text-[#71717a] space-y-1 list-disc list-inside">
              <li><strong className="text-[#f4f4f6]">8 Occupied / 3 Reserved / 12 Available</strong> — 34.8% occupied, 47.8% occupancy rate (incl. reserved). 6 doors with active tasks + 2 ghost-occupied (DOCK63, DOCK66).</li>
              ...
              <li>Customer mix: GURUNANDA (ORG-655875) on 7 of 9 tasks, KARAKA LLC (ORG-585450) on 1. Ghosts: DOCK63, DOCK66.</li>
              ...
              <li><strong className="text-[#7c3aed]">GURU LIVE OUT:</strong> TASK-5285558 (DOCK53, ~1d 8h, DN-3198181), TASK-5285913 (DOCK53, ~1d 2h, DN-3203261+1), TASK-5285860 (DOCK54, ~1d 3h, 4 DNs).</li>
              <li><strong className="text-[#f59e0b]">GURU LIVE IN:</strong> None — no GURUNANDA receive tasks for Arnulfo on Bay 4. 1 KARAKA receive (TASK-5285778, DOCK51, ~1d).</li>
              <li><strong className="text-[#ef4444]">⚠ DOCK54 DOUBLE-BOOKED:</strong> Lorenzo TASK-5285010 (~2d 3h, since Jun 4) + Arnulfo TASK-5285860 (~1d 3h, 4 DNs).</li>
              <li><strong className="text-[#ef4444]">⚠ DOCK53 DOUBLE-BOOKED:</strong> Arnulfo TASK-5285558 (~1d 8h) + TASK-5285913 (~1d 2h).</li>
              <li><strong className="text-[#ef4444]">⚠ AGING:</strong> TASK-5285010 (Lorenzo, DOCK54, ~2d 3h). TASK-5090739 (daira gonzalez, DOCK50, ~229d since Oct 2025). TASK-5254195 (~40 days), TASK-5252949 (~40 days) — stale RECEIVE on DOCK65. TASK-5207670 (~96 days, Caren, DOCK62).</li>
              <li><strong className="text-[#ef4444]">⚠ DOCK63 & DOCK66 ghost-occupied:</strong> dockStatus=OCCUPIED but zero active tasks. DOCK63 is a new ghost (was Reserved in prior pull).</li>
              <li><strong className="text-[#22c55e]">✅ DOCK52 & DOCK61 ghosts CLEARED since last pull:</strong> now Available.</li>
              <li><strong className="text-[#f4f4f6]">Key shift since Jun 5:</strong> Occupied 9→8 (6→6 active, 3→2 ghost). Reserved 8→3. Available 6→12. Major freeing of doors.</li>
              <li><strong className="text-[#f4f4f6]">Lorenzo Rodriguez:</strong> 1 task — DOCK54 (LOAD ~2d 3h, DN-3195089+DN-3195088). Aging — needs closing attention.</li>
              ...
              <li><strong className="text-[#f4f4f6]">Caren Cubides:</strong> 2 tasks — DOCK62 (RN-5006269, ~96d), DOCK65 (RN-183707, ~40d).</li>
              <li><strong className="text-[#f4f4f6]">Rufino Munguia:</strong> 1 task — DOCK65 (RN-5007343, ~40d).</li>
              <li>Schedule %: <strong className="text-[#71717a]">UNAVAILABLE</strong> — all BAM schedule-summary endpoints return SQL parse errors.</li>
              <li>Facility-wide: <strong className="text-[#22c55e]">{facilityInboundOpen}</strong> inbound open = <strong className="text-[#7c3aed]">{facilityOutboundOpen}</strong> outbound open — parity at 50/50 (was 52/52).</li>
              <li>All data sourced from live WISE/WMS queries at ~11:35 PM PDT, June 6, 2026.</li>
            </ul>
          </div>
        </section>
      </main>
      ...
      <footer className="border-t border-[#1e1e2a] bg-[#0a0a0f] mt-2">
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between text-xs text-[#71717a]">
          ...
          <span>Last updated: June 6, 2026 ~11:35 PM PDT</span>
        </div>
      </footer>
    </div>
  );
